...
if __name__ == "__main__":
    ...
    image_dir = '/pscratch/sd/j/junbeom/3.2.FA_warpped_nii' #'/master_ssd/3DCNN/data/1.ABCD/2.sMRI_freesurfer'
    phenotype_dir = '/global/cfs/cdirs/m3898/GANBERT/t1_harmonization/datasets/ABCD_phenotype_total.csv' #'/master_ssd/3DCNN/data/1.ABCD/4.demo_qc/ABCD_phenotype_total.csv'    
