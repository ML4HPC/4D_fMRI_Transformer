...
from .data_preprocess_and_load.data_module3_conf import fMRIDataModule #####
import torch
import warnings
import numpy as np
from tqdm import tqdm
from .model_conf import Encoder_Transformer_Decoder,Encoder_Transformer_finetune,AutoEncoder,MobileNet_v2_Transformer_finetune, MobileNet_v3_Transformer_finetune, Transformer_Net #####
...
class Trainer():
    ...
    def compute_binary_classification(self,input_dict,output_dict):
        ...
        print('binary loss is ', binary_loss)
