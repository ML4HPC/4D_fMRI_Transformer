...
torchrun --nnodes=1 --nproc_per_node=4 main.py --dataset_name ABCD --fine_tune_task binary_classification --target ADHD --num_workers 16 --dataset_split_num 1 --step 3 --batch_size_phase3 4 --exp_name polaris_job_ABCD --image_path /lus/grand/projects/STlearn/8.masked_image_MNI_to_TRs
