...
torchrun --nnodes=1 --nproc_per_node=4 main.py --dataset_split_num 1 --step 3 --batch_size_phase3 4 --exp_name polaris_job --init_method env --image_path /lus/grand/projects/STlearn/HCP_MNI_to_TRs/
