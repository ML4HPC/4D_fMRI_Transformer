...
#PBS -A STlearn
#PBS -j oe
#PBS -N prod_HCP_main_step3_mask_loss_age
...
Command="python main.py --step 3  --num_workers 16 --batch_size_phase3 4 --fine_tune_task regression --target age --exp_name split1  --image_path /lus/grand/projects/STlearn/HCP_MNI_to_TRs --dataset_split_num 1"
